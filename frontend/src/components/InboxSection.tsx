export default function InboxSection() {
  return (
    <div id="inbox-section" style={{ opacity: 0 }} className="fixed inset-0 pointer-events-none flex flex-col justify-end pb-[10%] max-[640px]:pb-[12%] sm:pb-[8%] items-center transition-all z-40 bg-[#050505]">
      {/* Content Layer - Now at the bottom */}
      <div className="w-full text-center max-w-4xl px-4 max-[640px]:px-3 sm:px-8 relative mb-2 sm:mb-4 transition-transform translate-y-4">
