export default function ProfileSection() {
  return (
    <section id="profile-section" className="scene-section" aria-label="It all starts with you">
        <div id="profile-text" className="fixed top-1/2 max-[640px]:top-[64%] -translate-y-1/2 left-[5%] max-[640px]:left-1/2 max-[640px]:-translate-x-1/2 w-[45%] max-[640px]:w-[90vw] z-10 pointer-events-none flex flex-col justify-center items-start max-[640px]:items-center max-[640px]:text-center" style={{opacity: 0}}>
