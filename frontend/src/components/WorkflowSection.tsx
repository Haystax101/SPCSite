...
export default function WorkflowSection() {
  return (
    <div id="workflow-section" aria-hidden="true" style={{ opacity: 0 }} className="fixed inset-0 pointer-events-none will-change-[opacity,transform] z-[100]">
      ...
      <div id="physical-inbox" className="absolute top-[42%] max-[1140px]:top-[46%] max-[640px]:top-[50%] left-1/2 -translate-x-1/2 -translate-y-1/2 w-[480px] h-[320px] max-[1140px]:w-[360px] max-[1140px]:h-[245px] max-[640px]:w-[300px] max-[640px]:h-[210px] pointer-events-none opacity-0 transition-opacity z-10">
      ...
      {/* Workflow Text */}
      <div id="wf-bg-text" className="absolute top-[12%] max-[1140px]:top-[9%] max-[640px]:top-[7%] left-1/2 -translate-x-1/2 w-full text-center max-w-4xl px-6 max-[1140px]:px-4 pointer-events-none z-20 transition-opacity">
        <h2 className="text-[2.8rem] max-[1140px]:text-[1.9rem] max-[640px]:text-[1.45rem] font-bold text-white tracking-tight drop-shadow-[0_10px_40px_rgba(0,0,0,0.8)] mb-4 max-[1140px]:mb-3 max-[640px]:mb-2 leading-[1.1]">
          Orchestrated Effortlessly.
        </h2>
        <p className="text-[1.1rem] max-[1140px]:text-[0.98rem] max-[640px]:text-[0.88rem] leading-relaxed text-gray-400 drop-shadow-[0_4px_10px_rgba(0,0,0,0.8)] text-center max-w-2xl max-[1140px]:max-w-[92vw] mx-auto">
      ...
      {/* Node 1: David */}
      <div id="wf-node-david" className="workflow-card absolute flex items-center gap-3 max-[1140px]:gap-2.5 max-[640px]:gap-2 w-[310px] max-[1140px]:w-[230px] max-[640px]:w-[185px] p-4 max-[1140px]:p-3 max-[640px]:p-2.5 border border-white/10 rounded-xl max-[640px]:rounded-lg bg-[#111] shadow-2xl transition-all will-change-[transform,opacity] opacity-0 z-30" style={{ top: '66%', left: '19.5%', transform: 'translate(-50%, -50%) scale(0.95)' }}>
        ...
        <div className="absolute right-[-6px] max-[640px]:right-[-5px] top-[25%] -translate-y-1/2 w-3 h-3 max-[640px]:w-2.5 max-[640px]:h-2.5 rounded-full bg-[#111] border-[2px] max-[640px]:border-[1.5px] border-yellow-400"></div>
        <div className="absolute right-[-6px] max-[640px]:right-[-5px] top-1/2 -translate-y-1/2 w-3 h-3 max-[640px]:w-2.5 max-[640px]:h-2.5 rounded-full bg-[#111] border-[2px] max-[640px]:border-[1.5px] border-yellow-400"></div>
        <div className="absolute right-[-6px] max-[640px]:right-[-5px] top-[75%] -translate-y-1/2 w-3 h-3 max-[640px]:w-2.5 max-[640px]:h-2.5 rounded-full bg-[#111] border-[2px] max-[640px]:border-[1.5px] border-yellow-400"></div>
      </div>

      {/* Node 2: Stats Image */}
      <div id="wf-node-stats" className="workflow-card absolute transition-all will-change-[transform,opacity] opacity-0 z-30 w-[340px] max-[1140px]:w-[260px] max-[640px]:w-[205px]" style={{ top: '66%', left: '50%', transform: 'translate(-50%, -50%) scale(0.95)' }}>
        <div className="relative w-full h-full p-2 max-[640px]:p-1.5 border border-white/10 rounded-xl max-[640px]:rounded-lg bg-[#111] shadow-2xl flex flex-col justify-center">
          ...
          <div className="absolute left-[-6px] max-[640px]:left-[-5px] top-[25%] -translate-y-1/2 w-3 h-3 max-[640px]:w-2.5 max-[640px]:h-2.5 rounded-full bg-[#111] border-[2px] max-[640px]:border-[1.5px] border-gray-500"></div>
          <div className="absolute left-[-6px] max-[640px]:left-[-5px] top-1/2 -translate-y-1/2 w-3 h-3 max-[640px]:w-2.5 max-[640px]:h-2.5 rounded-full bg-[#111] border-[2px] max-[640px]:border-[1.5px] border-gray-500"></div>
          <div className="absolute left-[-6px] max-[640px]:left-[-5px] top-[75%] -translate-y-1/2 w-3 h-3 max-[640px]:w-2.5 max-[640px]:h-2.5 rounded-full bg-[#111] border-[2px] max-[640px]:border-[1.5px] border-gray-500"></div>
      ...
      {/* Node 3: Elena */}
      <div id="wf-node-elena" className="workflow-card absolute flex items-center gap-3 max-[1140px]:gap-2.5 max-[640px]:gap-2 w-[260px] max-[1140px]:w-[195px] max-[640px]:w-[165px] p-3 max-[1140px]:p-2.5 max-[640px]:p-2 border border-white/10 rounded-xl max-[640px]:rounded-lg bg-[#111] shadow-2xl transition-all will-change-[transform,opacity] opacity-0 z-30" style={{ top: '66%', left: '85%', transform: 'translate(-50%, -50%) scale(0.95)' }}>
      ...
      {/* Node 4: Sarah */}
      <div id="wf-node-sarah" className="workflow-card absolute flex items-center gap-3 max-[1140px]:gap-2.5 max-[640px]:gap-2 w-[260px] max-[1140px]:w-[195px] max-[640px]:w-[165px] p-3 max-[1140px]:p-2.5 max-[640px]:p-2 border border-white/10 rounded-xl max-[640px]:rounded-lg bg-[#111] shadow-2xl transition-all will-change-[transform,opacity] opacity-0 z-30" style={{ top: '42%', left: '85%', transform: 'translate(-50%, -50%) scale(0.95)' }}>
      ...
      {/* Node 5: Michael */}
      <div id="wf-node-michael" className="workflow-card absolute flex items-center gap-3 max-[1140px]:gap-2.5 max-[640px]:gap-2 w-[260px] max-[1140px]:w-[195px] max-[640px]:w-[165px] p-3 max-[1140px]:p-2.5 max-[640px]:p-2 border border-white/10 rounded-xl max-[640px]:rounded-lg bg-[#111] shadow-2xl transition-all will-change-[transform,opacity] opacity-0 z-30" style={{ top: '90%', left: '85%', transform: 'translate(-50%, -50%) scale(0.95)' }}>
