...
export default function WorkflowSection() {
  return (
    <div id="workflow-section" aria-hidden="true" style={{ opacity: 0 }} className="fixed inset-0 pointer-events-none will-change-[opacity,transform] z-[100]">
      ...
      <div id="physical-inbox" className="absolute top-[42%] left-1/2 -translate-x-1/2 -translate-y-1/2 w-[480px] h-[320px] pointer-events-none opacity-0 transition-opacity z-10">
      ...
      <div id="wf-bg-text" className="absolute top-[12%] left-1/2 -translate-x-1/2 w-full text-center max-w-4xl px-6 pointer-events-none z-20 transition-opacity">
        <h2 className="text-[2.2rem] md:text-[2.8rem] font-bold text-white tracking-tight drop-shadow-[0_10px_40px_rgba(0,0,0,0.8)] mb-4 leading-[1.1]">
          Orchestrated Effortlessly.
        </h2>
        <p className="text-[1rem] md:text-[1.1rem] leading-relaxed text-gray-400 drop-shadow-[0_4px_10px_rgba(0,0,0,0.8)] text-center max-w-2xl mx-auto">
      ...
      {/* Node 1: David */}
      <div id="wf-node-david" className="workflow-card absolute flex items-center gap-3 w-[310px] p-4 border border-white/10 rounded-xl bg-[#111] shadow-2xl transition-all will-change-[transform,opacity] opacity-0 z-30" style={{ top: '72%', left: '19.5%', transform: 'translate(-50%, -50%) scale(0.95)' }}>
      ...
      {/* Node 2: Stats Image */}
      <div id="wf-node-stats" className="workflow-card absolute transition-all will-change-[transform,opacity] opacity-0 z-30" style={{ top: '72%', left: '50%', transform: 'translate(-50%, -50%) scale(0.95)', width: '340px' }}>
      ...
      {/* Node 3: Elena */}
      <div id="wf-node-elena" className="workflow-card absolute flex items-center gap-3 w-[260px] p-3 border border-white/10 rounded-xl bg-[#111] shadow-2xl transition-all will-change-[transform,opacity] opacity-0 z-30" style={{ top: '72%', left: '85%', transform: 'translate(-50%, -50%) scale(0.95)' }}>
      ...
      {/* Node 4: Sarah */}
      <div id="wf-node-sarah" className="workflow-card absolute flex items-center gap-3 w-[260px] p-3 border border-white/10 rounded-xl bg-[#111] shadow-2xl transition-all will-change-[transform,opacity] opacity-0 z-30" style={{ top: '48%', left: '85%', transform: 'translate(-50%, -50%) scale(0.95)' }}>
      ...
      {/* Node 5: Michael */}
      <div id="wf-node-michael" className="workflow-card absolute flex items-center gap-3 w-[260px] p-3 border border-white/10 rounded-xl bg-[#111] shadow-2xl transition-all will-change-[transform,opacity] opacity-0 z-30" style={{ top: '96%', left: '85%', transform: 'translate(-50%, -50%) scale(0.95)' }}>
